  ...
  return (
    <DropdownMenu >
      <DropdownMenuTrigger asChild>
        <Button
          className="w-full flex justify-between items-center px-0"
          variant="ghost"
        >
      ...
      <DropdownMenuContent className="w-52 mx-2 space-y-2">
        {isModerator && (
          <DropdownMenuItem
            ...
            className="flex justify-between items-center text-indigo-600 cursor-pointer dark:text-indigo-400 px-3 py-2 text-sm"
          >
            Invite Friends
        ...
        {isAdmin && (
          <DropdownMenuItem
            ...
            className="flex justify-between items-center cursor-pointer px-3 py-2 text-sm"
          >
            Server Settings
        ...
        {isAdmin && (
          <DropdownMenuItem
            ...
            className="flex justify-between items-center cursor-pointer px-3 text-rose-500 py-2 text-sm"
          >
            Delete Server
